...
// public class MatlabCommandTask extends Task<MatlabCommandTask, MatlabCommandTaskProperties> {
...
//      */
//     public MatlabCommandTask matlabCommand(@NotNull final String matlabCommand) {
